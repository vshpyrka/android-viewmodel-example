...
import com.example.viewmodel.databinding.ActivityViewModelSavedStateHandleBinding
...
class ViewModelSavedStateHandleActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch {
            viewModel.filteredData
                ...
                .collectLatest {
                    val items = it.joinToString(separator = "\n")
                    binding.textView.text = items
                }
        }
    }
}
